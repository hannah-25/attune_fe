        ...
        <div className="flex flex-col grow min-h-0 overflow-y-auto overscroll-contain basis-[0%] pt-16 pr-5 pb-4 pl-5">
          ...
          <div className="items-center flex gap-2 mt-4 px-1 text-xs">
            <button
              ...
              className={`items-center flex justify-center w-4 h-4 rounded shrink-[0] transition-colors ${autoLogin ? 'bg-purple-500' : 'border border-gray-300 bg-white'}`}
            >
              {autoLogin && (
            ...
            <button type="button" onClick={() => setAutoLogin((v) => !v)}>
              자동 로그인
            </button>
            <div className="grow basis-[0%]"></div>
            <button
              type="button"
              onClick={() => navigate('/reset-password/1')}
              className="font-medium underline text-gray-600 whitespace-nowrap"
            >
              비밀번호 찾기
            </button>
          </div>
          <button
            ...
            className="items-center flex font-bold justify-center w-full h-[46px] mt-6 bg-gray-900 shadow-[rgba(0,0,0,0.06)_0px_4px_0px_0px] text-white text-base tracking-tight min-h-11 pt-0 pr-5 pb-0 pl-5 rounded-xl"
          >
          ...
          <div className="flex justify-center gap-4 mt-3">
            <button type="button" className="items-center flex justify-center w-10 h-10 bg-white border border-gray-300 rounded-full shadow-sm">
            ...
            <button type="button" className="items-center flex justify-center w-10 h-10 bg-black rounded-full">
              <svg className="w-4 h-4" fill="white" viewBox="0 0 24 24">
                <path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09l.01-.01zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z"/>
              </svg>
            </button>
            <button type="button" className="items-center flex justify-center w-10 h-10 rounded-full" style={{backgroundColor: '#FEE500'}}>
