        ...
        <div className="flex flex-col grow min-h-0 overflow-y-auto overscroll-contain basis-[0%] pt-5 pr-5 pb-4 pl-5">
          ...
          <div className="mt-5">
            <button
              ...
              className="items-start flex gap-2 mb-1.5 w-full text-left"
            >
              <div className={`items-center flex justify-center w-4 h-4 rounded shrink-[0] mt-0.5 transition-colors ${agreeTerms ? 'bg-purple-500' : 'border border-gray-300 bg-white'}`}>
                {agreeTerms && (
            ...
            <button
              ...
              className="items-start flex gap-2 w-full text-left"
            >
              <div className={`items-center flex justify-center w-4 h-4 rounded shrink-[0] mt-0.5 transition-colors ${agreeMarketing ? 'bg-purple-500' : 'border border-gray-400 bg-white'}`}>
                {agreeMarketing && (
                  <div className="overflow-hidden w-2.5 h-2.5">
                    <img src="/icons/f65a7410da47c5d2b396b5d6f7c374acd3be6f7e.svg" className="block size-full" />
                  </div>
